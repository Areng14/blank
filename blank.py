...
def show_progress(title, task, ftitle):
    ...
    progress_bar = ttk.Progressbar(progress_window, bootstyle="success", orient='horizontal', length=300, mode='determinate')
...
def main():
    ...
    if file_ext in ['.png', '.jpg', '.jpeg']:
        ...
        def convert_blank_to_image(callback):
            ...
            os.rename(output_path,os.path.splitext(input_path)[0] + ".png")
